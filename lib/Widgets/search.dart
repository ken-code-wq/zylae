  ...
  Widget buildSuggestions(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) => ListTile(
        ...
        title: Text(
          suggestionList[index].title.trim() != '' ? suggestionList[index].title : suggestionList[index].displayNameWOExt,
          overflow: TextOverflow.ellipsis,
        ),
        subtitle: Text(
          suggestionList[index].artist! == '<unknown>' ? "Unknown" : suggestionList[index].artist!,
          overflow: TextOverflow.ellipsis,
        ),
        onTap: () async {
          PlayerInvoke.init(
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestionList = query.isEmpty
        ...
        : [
            ...{
              ...data.where(
                (element) => element['title'].toString().toLowerCase().contains(query.toLowerCase()),
              ),
              ...data.where(
                (element) => element['artist'].toString().toLowerCase().contains(query.toLowerCase()),
              ),
            },
          ];
    return ListView.builder(
      ...
      itemBuilder: (context, index) => ListTile(
        leading: imageCard(
          imageUrl: isDowns ? suggestionList[index]['image'].toString() : suggestionList[index]['image'].toString(),
          localImage: isDowns,
        ),
        title: Text(
