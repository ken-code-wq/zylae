  ...
  try {
    final List result = itemsList.map((e) {
      return {
        ...
        'type': 'chart',
        'subtitle': e['gridPlaylistRenderer']['shortBylineText']['runs'][0]['text'],
        'count': e['gridPlaylistRenderer']['videoCountText']['runs'][0]['text'],
        'id': 'youtube${e['gridPlaylistRenderer']['navigationEndpoint']['watchEndpoint']['playlistId']}',
        'firstItemId': 'youtube${e['gridPlaylistRenderer']['navigationEndpoint']['watchEndpoint']['videoId']}',
        'image': e['gridPlaylistRenderer']['thumbnail']['thumbnails'][0]['url'],
        'images': e['gridPlaylistRenderer']['thumbnail']['thumbnails'].map((e) => e['url']).toList(),
        'provider': 'youtube',
      };
    }).toList();
  ...
  try {
    final List result = itemsList.map((e) {
      return {
        ...
        'id': 'youtube${e['compactStationRenderer']['navigationEndpoint']['watchEndpoint']['playlistId']}',
        'firstItemId': 'youtube${e['compactStationRenderer']['navigationEndpoint']['watchEndpoint']['videoId']}',
  ...
  try {
    final List result = itemsList.map((e) {
      return {
        ...
        'id': 'youtube${e['defaultPromoPanelRenderer']['navigationEndpoint']['watchEndpoint']['videoId']}',
        'firstItemId': 'youtube${e['defaultPromoPanelRenderer']['navigationEndpoint']['watchEndpoint']['videoId']}',
        ...
        'images': e['defaultPromoPanelRenderer']['largeFormFactorBackgroundThumbnail']['thumbnailLandscapePortraitRenderer']['landscape']['thumbnails'].map((e) => e['url']).toList(),
        'provider': 'youtube'
      };
    }).toList();
  ...
  try {
    final List result = itemsList.map((e) {
      return {
        ...
        'images': e['gridVideoRenderer']['thumbnail']['thumbnails'].map((e) => e['url']).toList(),
        'provider': 'youtube'
      };
    }).toList();
  ...
  for (Map e in items) {
    if (e['compactStationRenderer'] != null) {
      ...
      result.add({
        'title': e['gridVideoRenderer']['title']['simpleText'],
        'type': 'video',
        'subtitle': e['gridVideoRenderer']['shortBylineText']['runs'][0]['text'],
