  ...
  factory SongItem.fromMap(Map<dynamic, dynamic> map) {
    try {
      ...
      final songItem = SongItem(
        ...
        artists: map['artists'] as List<String>? ?? map['artist']?.split(',') as List<String>? ?? [],
        duration: Duration(
          seconds: dur,
        ),
        genre: map['genre'].toString(),
        image: map['image'].toString(),
        allImages: map['allImages'] as List? ?? map['allImages'] as List? ?? (map['image']?.toString() != null ? [map['image']?.toString()] : []),
        language: map['language']?.toString(),
        releaseDate: map['releaseDate']?.toString(),
        subtitle: map['subtitle']?.toString(),
        title: map['title'].toString(),
        url: map['url']?.toString(),
        allUrls: map['allUrls'] as List<String>? ?? ((map['url'] != null && map['url'] != '') ? [map['url'].toString()] : []),
