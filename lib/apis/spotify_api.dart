...
class SpotifyApi {
  ...
  final String myClientID = '2304f3a9d71c4ee0a2e1803fee187ae4';
  final String myClientSecret = '321d17b7da564faa98ddbb37b20e54a1';
  final String redirectUrl = 'https%3A%2F%2Fapi-university.com%2F';
  ...
  final String refreshToken = "AQD7ALp6fF45HjvFLtAbgRRT-FJjmukafizqfsyMeip-HMlWD4Fyhjg4hCWsMjtlJia74MxYN23DyLjrmsSvKbc6a9le4YdzYu2PsZDTUclcl21NjMEqzh7F0nXW-nyw9PA";

  String requestAuthorization() => 'https://accounts.spotify.com/authorize?client_id=$myClientID&response_type=code&redirect_uri=$redirectUrl&scope=${_scopes.join('%20')}';
  ...
  Future<List<String>> getAccessToken({
    ...
    final Map<String, String> headers = {
      'Authorization': "Basic ${base64.encode(utf8.encode("$myClientID:$myClientSecret"))}",
    };

    Map<String, String>? body;
    body = {
      'grant_type': 'refresh_token',
      'refresh_token': "AQD7ALp6fF45HjvFLtAbgRRT-FJjmukafizqfsyMeip-HMlWD4Fyhjg4hCWsMjtlJia74MxYN23DyLjrmsSvKbc6a9le4YdzYu2PsZDTUclcl21NjMEqzh7F0nXW-nyw9PA",
    };
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Hive.box('settings').put('spotifyAccessToken', result['access_token'].toString());
        return <String>[
        ...
        print(
          'Error in getAccessToken, called: $path, returned: ${response.statusCode} ${response.body}',
        );
      }
    } catch (e) {
      print('Error in getting spotify access token: $e');
    }
    return [];
  }
  ...
  Future<List> getUserPlaylists(String accessToken) async {
    try {
      final Uri path = Uri.parse('$spotifyApiBaseUrl$spotifyUserPlaylistEndpoint?limit=50');
  ...
  Future<Map> searchTrack({
    ...
    if (response.statusCode == 200) {
      ...
      print(
        'Error in searchTrack, called: $path, returned: ${response.statusCode} ${response.body}',
      );
    }
    return {};
  }
